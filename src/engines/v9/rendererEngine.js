...
export function renderWithV9({ product = {}, pageDesign = {} } = {}) {
  ...
  const cards = profile.story
    ? profile.story.features.slice(0, 4).map((value, index) => ({ label: ["핵심", "기준", "품질", "활용"][index] || "정보", value }))
  ...
  const purchasePoints = profile.story
