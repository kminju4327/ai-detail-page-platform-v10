...
export function removeCopyRepetition(page = {}) {
  ...
  const next = {
    ...page,
    hero_headline: replaceRepeatedEnding(page.hero_headline, usedEndings),
    hero_subcopy: replaceRepeatedEnding(page.hero_subcopy, usedEndings),
  };
